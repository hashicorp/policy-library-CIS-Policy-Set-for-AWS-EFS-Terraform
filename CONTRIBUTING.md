...
To record a bug report, enhancement proposal, or give any other product feedback, please [open a GitHub issue](https://github.com/hashicorp/policy-library-cis-aws-efs-terraform/issues/new/choose) using the most appropriate issue template.
...
(either in [a new GitHub issue](https://github.com/hashicorp/policy-library-cis-aws-efs-terraform/issues/new/choose) or an existing one, as appropriate)
...
```
cd policy-library-cis-aws-efs-terraform
sentinel version
```
